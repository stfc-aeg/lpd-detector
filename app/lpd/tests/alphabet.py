...
if __name__ == '__main__':
    ...
    # Draw 10 - On eight ASICs within one tile
    (tile, asic) = (10, None)
    a.insertComment( "TILE 10, Labelled Numeral 10")
    (start, stop) = (115, 227)
    ...
    number = 15
    (tile, asic) = (number, None)
    a.insertComment( "TILE %s, Labelled Numeral %s" %  (number, number))
    (start, stop) = (33, 241)
    a.verticalLine( tile, asic, start, stop)
    (start, stop) = (34, 36)
    a.horizontalLine( tile, asic, start, stop)
