...
# each FPGA F1 to F4 has 2 Xaui 10G channels
    ...
    data_gen_2    = 0x0c000000    #12   data gen to ppc1 dma
    data_gen_3    = 0x0d000000    #13   data gen to ppc2 dma
    bram_ppc1    = 0x0e000000    #14    comms to ppc1
    bram_ppc2    = 0x0f000000    #15    comms to ppc2
