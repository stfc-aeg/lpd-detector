...
typedef enum {
	...
	unknownReadWriteMode = -1,
	sequentialReadWriteMode,
	continuousReadWriteMode
...
typedef struct
{
	...
	unsigned int      equalizeTHH;
	mpx3ColourMode	  colourMode;
	unsigned int	  pixelComEnable;
	unsigned int 	  shutterCtr;
