 ...
 */
u32 FemClient::personalityWrite(unsigned int aCommand, unsigned int aWidth, u8* aPayload, std::size_t size)
{
...
FemTransaction FemClient::personalityCommand(unsigned int aCommand, unsigned int aWidth, u8* aPayload, std::size_t size)
{
