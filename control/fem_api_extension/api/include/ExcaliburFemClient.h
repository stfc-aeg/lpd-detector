...
typedef enum
{
	...
	excaliburTriggerModeInternal = 0,
	excaliburTriggerModeExternal = 1,
	excaliburTriggerModeSync     = 2,
...
typedef enum
{
	...
	excaliburTriggerPolarityActiveHigh = 0,
	excaliburTriggerPolarityActiveLow  = 1,
