 ...
 * @param mode
 * @param timeoutMax number of loop iterations to try receive response before giving up
...
int acquireConfigMsgSend(u32 cmd, u32 bufferSz, u32 bufferCnt, u32 numAcq, u32 mode, int timeoutMax)
{
	u32 buf[5];
	u32 sentBytes = 0;
	u32 msgSize = 20;
