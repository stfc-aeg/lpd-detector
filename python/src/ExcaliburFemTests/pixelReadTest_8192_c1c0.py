...
theFem.rdmaWrite(0x48000000, (0x80,))    # ASIC MUX select (was 0xFF)
theFem.rdmaWrite(0x48000002, (0x3860,))  # OMR LSB
theFem.rdmaWrite(0x48000003, (0x0,))     # OMR MSB
theFem.rdmaWrite(0x48000006, (0xFF,))	# was 0xF
theFem.rdmaWrite(0x48000007, (0xF,))	# was 0xF
theFem.rdmaWrite(0x48000008, (0x8,))	# frame counter was 0x1
theFem.rdmaWrite(0x4800000A, (0x7F,))	# was 0x5
